...
export default function AntiRaidPage() {
        ...
        const fetchData = async () => {
            ...
            try {
                const [configRes, serverDetailsRes] = await Promise.all([
                    fetch(`${API_URL}/get-config/${serverId}/anti-raid`),
    ...
    const saveConfig = async (newConfig: AntiRaidConfig) => {
        ...
        try {
            await fetch(`${API_URL}/update-config/${serverId}/anti-raid`, {
                method: 'POST',
    ...
    <PageTransitionWrapper className="space-y-8 max-w-4xl">
        <div>
            ...
            <p className="text-muted-foreground mt-2">
                Protégez le serveur contre les arrivées massives et rapides de nouveaux membres.
            </p>
        </div>
        ...
        <Separator />
            <Card>
                <CardHeader>
                    <CardTitle>Configuration de l'Anti-Raid</CardTitle>
                    <CardDescription>
                        Personnalisez le comportement du module pour contrer les raids.
                    </CardDescription>
                </CardHeader>
                    ...
                    <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground/80">
                                    Active ou désactive la détection de raid.
                                </p>
                            </div>
