...
import { Dice5, MessageCircle, Flag, Ban, RussianRuble, HandCoins, Gift } from 'lucide-react';
...
const funCommands = [
    ...
    { name: '/airdrop', key: 'airdrop', description: 'Crée un airdrop d\'XP dans le salon.', isLevel: true, defaultEveryone: false, icon: Gift },
