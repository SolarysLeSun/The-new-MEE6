    ...
    <PageTransitionWrapper className="space-y-8">
        ...
        <Card>
            ...
            <p className="text-muted-foreground">
                Configurez les fonctionnalités de planification d'événements.
            </p>
            </CardHeader>
            ...
            <div className="opacity-50">
                ...
                <div className="flex items-center justify-between pt-6">
                    ...
                    <Switch id="suggest-time" checked={config.suggest_time} disabled />
                </div>
                ...
                <div className="flex items-center justify-between pt-6">
                    ...
                    <Switch id="rsvp-tracking" checked={config.rsvp_tracking} disabled />
                </div>
                </div>
            </CardContent>
        </Card>
    ...
    <PageTransitionWrapper className="space-y-8 text-white max-w-4xl">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Planifiez des événements pour votre communauté directement depuis Discord.
        </p>
      </div>
