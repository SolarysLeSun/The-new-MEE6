    ...
    return (
        <div className="relative min-h-screen w-full bg-background text-foreground">
            ...
            <main className="relative z-10 container mx-auto px-4 py-16 sm:py-24 text-center">
                <Badge variant="outline" className="mb-4 border-primary/50 text-primary">Créé par Forge Network</Badge>
                ...
                <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <a href={supportServerUrl} target="_blank" rel="noopener noreferrer">
                        <Button size="lg" variant="outline" className="w-full sm:w-auto text-lg py-7 px-8">
                            Rejoindre le support & Giveaways
                        </Button>
                    </a>
                </div>
            ...
            <section id="features" className="relative z-10 container mx-auto px-4 pb-24">
             ...
             <footer className="relative z-10 text-center pb-8">
                 <p className="text-muted-foreground">Développé avec ❤️ par <a href="https://forgenet.fr" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Forge Network</a>.</p>
            </footer>
        </div>
    );
}
